...
def top_statistics(selected_user, df):
...
def activity_maps(selected_user, df):
...
def main():
    ...
    if uploaded_file is not None:
        ...
        if st.sidebar.button("Show Analysis"):
            top_statistics(selected_user, df)
            monthly_timeline(selected_user, df)
            daily_timeline(selected_user, df)
            activity_maps(selected_user, df)
            weekly_heatmap(selected_user, df)

            if selected_user == 'Overall':
                busiest_users(df)

            wordcloud(selected_user, df)
            most_common_words(selected_user, df)
            emoji_analysis(selected_user, df)
